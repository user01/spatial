...
module Spatial {
  export class Ramp {
    ...
    constructor(public type:RampType=RampType.Linear,
                public valueStart:number=1,
                public valueEnd:number=0,
                public rangeStart:number=0,
                public rangeEnd:number=0
                ){
      if (this.rangeEnd > this.rangeStart) this.rangeEnd = this.rangeStart;
    }
    ...
    public static ValueAt = (ramp:Ramp,range:number):number => {
      ...
      var valueRange = ramp.valueEnd - ramp.valueStart;
