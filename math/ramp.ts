...
export class Factor implements ISerializable, IEquality<Factor> {
  ...
  public Clone = () => {
    return Factor.CloneStatic(this);
  }
  public static CloneStatic = (factor: Factor) => {
...
export class Decay implements ISerializable, IEquality<Decay> {
  ...
  public Clone = () => {
    return Decay.CloneState(this);
  }
  public static CloneState = (other: Decay) => {
...
export class Falloff implements ISerializable, IEquality<Falloff> {
  ...
  public Clone = (): Falloff => {
    return Falloff.CloneStatic(this);
  }
  public static CloneStatic = (other: Falloff): Falloff => {
