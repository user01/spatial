...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ramp = __webpack_require__(2);
...
/***/ function(module, exports) {
	...
	var Ramp = (function () {
	    ...
	    Object.defineProperty(Ramp.prototype, "Duration", {
	        get: function () {
	            return this._rangeEnd - this._rangeStart;
	        },
	        enumerable: true,
	        configurable: true
	    });
	    Object.defineProperty(Ramp.prototype, "ValueChange", {
	        get: function () {
	            return this._valueEnd - this._valueStart;
	        },
	        enumerable: true,
	        configurable: true
	    });
	    ...
	    Ramp.Equal = function (r1, r2) {
	        if (r1._type != r2._type)
	            return false;
	        var delta = (r1._valueStart - r2._valueStart) + (r1._valueEnd - r2._valueEnd) + (r1._rangeStart - r2._rangeStart) + (r1._rangeEnd - r2._rangeEnd);
	    ...
	    Ramp.Build = function (r) {
	        ...
	        if (r == null) {
	            ...
	            return (r.indexOf('{') == 0) ? Ramp.FromStr(r) : new Ramp(r);
	        }
	        return r;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (Vector) {
	    var VectorBase = (function () {
	        function VectorBase(valueSet, r) {
	            var _this = this;
	            if (r === void 0) { r = null; }
	            this.Clone = function () {
	        ...
	        Object.defineProperty(VectorBase.prototype, "Ramp", {
	            get: function () {
	                return this._ramp;
	            },
	            enumerable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (Segment) {
	    var SegmentBase = (function () {
	        function SegmentBase(_base, _tip, r) {
	            var _this = this;
	            if (r === void 0) { r = null; }
	            this._base = _base;
	            this._tip = _tip;
	            ...
	            this.IntensityAt = function (v) {
	                ...
	                var intensity = Ramp.Mix(_this.Base.Ramp, _this.Tip.Ramp, fraction, range);
	                return intensity;
	            };
	            this.ClosestVector = function (v) {
	        ...
	        Object.defineProperty(SegmentBase.prototype, "Ramp", {
	            get: function () {
	                return this._ramp;
	            },
	            enumerable: true,
	        ...
	        SegmentBase.FromObj = function (obj) {
	            switch (obj.t) {
	                case 2:
	                    return new Segment2(Vector.Vector2.FromObj(obj.b), Vector.Vector2.FromObj(obj.e), Ramp.FromObj(obj.r));
	                case 3:
	                    return new Segment3(Vector.Vector3.FromObj(obj.b), Vector.Vector3.FromObj(obj.e), Ramp.FromObj(obj.r));
	                case 4:
	                    return new Segment4(Vector.Vector4.FromObj(obj.b), Vector.Vector4.FromObj(obj.e), Ramp.FromObj(obj.r));
	            }
	            //default untyped
	            return new SegmentBase(Vector.VectorBase.FromObj(obj.b), Vector.VectorBase.FromObj(obj.e), Ramp.FromObj(obj.r));
	        };
	    ...
	    var SegmentSet = (function () {
	        function SegmentSet(segments) {
	            ...
	            this.IntensityAt = function (v) {
	                return _this.closestVectorIntensity(v)[1];
	            };
	            this.ClosestVector = function (v) {
