...
describe('Vector', () => {
  describe('Vector2', () => {
    ...
    describe('Intensity', () => {
      it('Simple', () => {
        var ramp: Ramp.Ramp = new Ramp.Ramp('linear', 10, 0, 10, 110);
        var v2A: Vector.Vector2 = new Vector.Vector2(0, 0,
          new Ramp.Factor(Ramp.Decay.PermanentDecay(),
            new Ramp.Falloff([ramp])));
