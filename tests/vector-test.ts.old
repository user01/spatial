...
describe('Vector2', () => {
  ...
  it('Equals', () => {
    ...
    Spatial.Vector2.EqualStatic(v2,v2A).should.be.exactly(true);
    v2.Equal(v2A).should.be.exactly(true);
    var v2 = new Spatial.Vector2(5,11);
    var v2A = new Spatial.Vector2(5,10);
    Spatial.Vector2.EqualStatic(v2,v2A).should.be.exactly(false);
  ...
  describe('Distance', () => {
    it('Simple static', () => {
      ...
      var distance = Spatial.Vector2.DistanceToStatic(v2A,v2B);
...
describe('Vector3', () => {
  ...
  describe('Distance', () => {
    it('Simple static', () => {
      ...
      var distance = Spatial.Vector3.DistanceToStatic(v3A,v3B);
      distance.should.be.exactly(10);
    });
    it('Simple', () => {
      var v3A = new Spatial.Vector3(0,0,0);
  ...
  describe('Cross', () => {
    it('Simple static', () => {
      ...
      var cross = Spatial.Vector3.CrossStatic(v3A,v3B);
...
describe('Vector4', () => {
  ...
  describe('Distance', () => {
    it('Simple static', () => {
      ...
      var distance = Spatial.Vector4.DistanceToStatic(v4A,v4B);
      distance.should.be.exactly(10);
    });
    it('Simple', () => {
      var v4A = new Spatial.Vector4(0,0,0,0);
